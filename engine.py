...
{{
  ...
  "action": {{
    "type": "ask|probe|clue|scaffold_example|small_lecture|examiner_verify|emote|persuade|next|recap",
    ...
    *,
    ...
    if not understood_claim:
        ...
        if (
            ...
            and action_type in {"ask", "probe", "clue", "scaffold_example", "small_lecture", "examiner_verify"}
        ):
            action_type = "recap"
            action_type_changed = True
