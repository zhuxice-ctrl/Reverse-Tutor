...
<p align="center">
  ...
  <img alt="Current APK" src="https://img.shields.io/badge/apk-0.17.12-0f766e?style=for-the-badge">
...
<p align="center">
  <a href="https://dl.zeroxcore.tech/reverse-tutor/Reverse-Tutor-v0.17.12.apk"><strong>下载 Android APK</strong></a>
  ·
...
- 自建高速源：https://dl.zeroxcore.tech/reverse-tutor/Reverse-Tutor-v0.17.12.apk
...
```json
{
  "versionCode": 33,
  "versionName": "0.17.12",
  "apkUrl": "https://dl.zeroxcore.tech/reverse-tutor/Reverse-Tutor-v0.17.12.apk",
  "apkMirrors": [
    "https://github.com/zhuxice-ctrl/Reverse-Tutor/releases/download/v0.17.12/Reverse-Tutor-v0.17.12.apk"
  ],
