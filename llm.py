...
_MOCK_LINES = {
    ...
    "scaffold_example": [
        "老师，我先拿一个 **{kp}** 的小例子来看：比如 f(x)=x³−3x，先求导得 3x²−3=0 → x=±1。你能说说为什么是这两个点吗？",
        "老师，我找到一个小例子想问你：设 g(x)=eˣ−x−1，在 x=0 处 g(0)=0。你觉得 x=0 是极值点吗？为什么？",
        "诶老师你看这个例子：二次函数 y=x²−4x+3，对称轴是 x=2。那 **{kp}** 跟这个对称轴啥关系？",
    ],
    "small_lecture": [
        "老师，我之前一直搞混了一个地方。关于 **{kp}**——其实关键是符号方向要跟着条件走，不是反过来。你能用自己的话重新说一遍吗？",
        "老师，我发现我之前 **{kp}** 的错误出在第一步条件判断。正确的做法是先看范围再代值。你能解释一下为什么是这个顺序吗？",
    ],
    "examiner_verify": [
